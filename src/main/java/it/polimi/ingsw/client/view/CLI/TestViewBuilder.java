...
public class TestViewBuilder extends it.polimi.ingsw.client.view.abstractview.TestViewBuilder implements CLIBuilder {
    ...
    public void run() {
        ...
        //
        //Row horList = new Row(getCLIView().getMaxBodyHeight(), CLI.width);
        //
        //horList.addElem(Option.from("12345678901234567890\nname1","subtitle1",()->{
        ...
        //
        //horList.addElem(Option.from(new Drawable(d2,d3),()->{
        //    resSelected.getAndIncrement();
        //    getCLIView().setTitle(new Title("Selected res "+resSelected.get()));
        //    getCLIView().setBody(hor);
        //    getCLIView().show();
    ...
    //            getCLIView().show();
    //        } else {
    //            hor.getHorizontalList().setMode(Row.Mode.COMPACT);
    ...
    //            getCLIView().show();
    //        } else {
    //            hor.getHorizontalList().setMode(Row.Mode.WIDE);
