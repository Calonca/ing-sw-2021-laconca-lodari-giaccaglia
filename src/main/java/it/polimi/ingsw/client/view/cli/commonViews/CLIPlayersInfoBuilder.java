...
public final class CLIPlayersInfoBuilder{
    ...
    private static Column buildInfo(){
        ...
        ViewBuilder boardViewBuilder;
        ViewBuilder leadersViewBuilder;
        ...
        for (int playerIndex = 0; playerIndex<players; playerIndex++) {
            ...
            if(Objects.requireNonNull(getThisPlayerCache()).getCurrentState().equals(State.IDLE.toString())) {
