...
public class CommonGsonAdapters {
    ...
    public static final RuntimeTypeAdapterFactory<SimpleModelElement> gsonElementAdapter = gsonElementAdapter();
    public static final RuntimeTypeAdapterFactory<Event> gsonEventMessageAdapter = gsonEventMessageAdapter();
