 ...
 */
public class ChooseResourceForCardShopEvent extends MiddlePhaseEvent {

    /**
     * List of ints representing current player chosen {@link it.polimi.ingsw.server.model.Resource Resources} positions
     * for DevCard purchase.
     */
    protected List<Integer> chosenResources;
