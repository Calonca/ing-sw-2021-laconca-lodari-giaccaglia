...
public class MoveResourceEvent extends MarketBoardEvent {
    ...
    /**
     * Client side {@link Event} constructor invoked when {@link it.polimi.ingsw.server.model.player.State#CHOOSING_POSITION_FOR_RESOURCES CHOOSING_POSITION_FOR_RESOURCES}
