...
public class PayResources extends GameStrategy
{
    public State execute(GameModel gamemodel)
    {
        ...
        int a=gamemodel.getCurrentPlayer().getPersonalBoard().getStrongBox().getTotalSelected()+gamemodel.getCurrentPlayer().getPersonalBoard().getWarehouseLeadersDepots().getTotalSelected();
