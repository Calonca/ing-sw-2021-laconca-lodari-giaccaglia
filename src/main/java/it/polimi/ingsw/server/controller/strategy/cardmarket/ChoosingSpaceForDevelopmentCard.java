...
public class ChoosingSpaceForDevelopmentCard implements GameStrategy {
    ...
    public Pair<State, List<Element>> execute(GameModel gamemodel, Validable event)
    {
        ...
        if((gamemodel.isSomeDevCardColourOutOfStock() && gamemodel.isSinglePlayer()) || (gamemodel.getCurrentPlayer().getPersonalBoard().playerHasSevenCards() && !gamemodel.isSinglePlayer()))
